...
typedef enum
{
    ...
    CFG_PARAM_3RD_HARMONIC_ENABLED,  //(obsolete) Enable setting frequency on 3rd harmonic (1) above BAND_FMAX, or disabe (0)
    ...
    CFG_PARAM_THICK_LINES,           //Enable thick lines on graphs and Smith chart
